...
describe('utils', () => {
  ...
  test('getHardwareDetails', () => {
    ...
    // const UA_W10_8664 =
    //   'Mozilla/5.0 (Windows NT 10.0; Win64; x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36 Edge/12.246'
    // Object.defineProperty(navigator, 'userAgent', { value: UA_W10_8664 })
    // expect(getHardwareDetails().os).toBe('Windows')
    // expect(getHardwareDetails().architecture).toBe('64-bit')
    // const UA_W10_32 =
    //   'Mozilla/5.0 (Windows NT 10.0; Win64; x32) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36 Edge/12.246'
    // Object.defineProperty(navigator, 'userAgent', { value: UA_W10_32 })
    // expect(getHardwareDetails().os).toBe('Windows')
    // expect(getHardwareDetails().architecture).toBe('32-bit')
    // // - Linux
    // const UA_LNX_64 =
    //   'Mozilla/5.0 (X11; Ubuntu; Linux x64; rv:15.0) Gecko/20100101 Firefox/15.0.1'
    ...
    // expect(getHardwareDetails().architecture).toBe('64-bit')
    // const UA_LNX_32 =
    //   'Mozilla/5.0 (X11; Ubuntu; Linux x32; rv:15.0) Gecko/20100101 Firefox/15.0.1'
    ...
    // // - ChromeOS
    // const UA_CROS_64 =
    //   'Mozilla/5.0 (X11; CrOS x64 8172.45.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.64 Safari/537.36'
    ...
    // expect(getHardwareDetails().architecture).toBe('64-bit')
    // const UA_CROS_32 =
    //   'Mozilla/5.0 (X11; CrOS x32 8172.45.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.64 Safari/537.36'
